 ...
 *
 * NOTE: this is a copy of `src/utils/parseInputsLog.ts` from the frontend. Kept as a
 * second copy to avoid setting up a shared package; the file is small and stable.
 */
